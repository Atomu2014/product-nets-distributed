...
tf.app.flags.DEFINE_string('nn_layers', '[' + '["full", 400],  ["act", "relu"], '*3 + '["full", 1]]', 'Network structure')
tf.app.flags.DEFINE_string('sub_nn_layers', '[["full", 20], ["ln", ""], ["act", "relu"], ["full", 1],  ["ln", ""]]', 'Sub-network structure')
